var FormWizard = function () {
    ...
    var handleDatetimePicker = function () {   $(".form_datetime").datetimepicker({
                ...
                $.ajax({
                    ...
                    success: function (json) {
                        if (json) {
                            ...
                            $.each(json, function(i, item) {//item相当于一条记录
                                $("#upperBoundarySection").append("<option value=" + item.sectionnumber + ">" + item.name + "</option>");
                                $("#lowerBoundarySection").append("<option value=" + item.sectionnumber + ">" + item.name + "</option>");
                            });
                        }
                    }
                });
